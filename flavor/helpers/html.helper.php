...
class html extends singleton {
	...
	public function imageLink($url="", $html_attributes="", $name, $alt=""){
	...
	public function imageLinkAbsolute($url="", $html_attributes="", $name, $alt=""){
		$html = "<a href=\"".$url;
		$html .= "\"";
		$html .= " $html_attributes ";
		$html .= ">";
		$html .= "<img src=\"".$name."\" alt=\"".$alt."\" title=\"".$alt."\" />";
		$html .= "</a>";
		return $html;
	}
